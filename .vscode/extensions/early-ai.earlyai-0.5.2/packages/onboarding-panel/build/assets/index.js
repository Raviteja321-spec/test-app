    ...
    (async () => {
      try {
        const response = await fetch(
          "https://raw.githubusercontent.com/earlyai/earlyai-vscode-release/main/docs/setup-and-configuration-guide.md"
        );
        const text2 = await response.text();
        setMarkdownContent(text2);
      } catch {
        setMarkdownContent(
          "## Oops! We couldn't load the content.\nPlease check your internet connection and try again.\n\nYou can also check the Setup and Configuration Guide [here](https://www.startearly.ai/docs/setup-and-configuration-guide)."
        );
      }
    })();
  }, []);
  return /* @__PURE__ */ jsxRuntimeExports.jsx("main", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Markdown, { children: markdownContent }) });
}
